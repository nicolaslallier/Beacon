...
echo "DNS configuration applied for ${ZONE_NAME}, ${BEACON_HOST}, ${N8N_HOST}, ${PGADMIN_HOST}, ${GRAFANA_HOST}, ${KEYCLOAK_HOST}, ${DNS_HOST}, ${MINIO_HOST}, ${BEACON_OLLAMA_HOST}, ${BEACON_OLLAMA_WEBUI_HOST}, ${OLLAMA_HOST}, ${LMSTUDIO_HOST}, ${POSTGRESQL_HOST}, ${VECTORDB_HOST}, ${REDIS_HOST}, ${SUPABASE_HOST}, ${CHROMADB_HOST}, ${QA_HOST} -> ${TARGET_IP}"
