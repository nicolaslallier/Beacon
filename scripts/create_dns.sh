...
S3_HOST="${TECHNITIUM_S3_HOST:-s3.beacon.famillelallier.net}"
...
BEACON_VECTORDB_HOST="${TECHNITIUM_BEACON_VECTORDB_HOST:-${TECHNITIUM_VECTORDB_HOST:-vectordb.beacon.famillelallier.net}}"
...
QA_HOST="${TECHNITIUM_QA_HOST:-qa.beacon.famillelallier.net}"
TOOLS_HOST="${TECHNITIUM_TOOLS_HOST:-tools.beacon.famillelallier.net}"
BEACON_TOOLS_DB_HOST="${TECHNITIUM_BEACON_TOOLS_DB_HOST:-beacon-tools.db.beacon.famillelallier.net}"
...
add_record "${VECTORDB_HOST}"
add_record "${REDIS_HOST}"
add_record "${SUPABASE_HOST}"
add_record "${CHROMADB_HOST}"
add_record "${QA_HOST}"
add_record "${TOOLS_HOST}"
add_record "${BEACON_TOOLS_DB_HOST}"

echo "DNS configuration applied for ${ZONE_NAME}, ${BEACON_HOST}, ${N8N_HOST}, ${PGADMIN_HOST}, ${GRAFANA_HOST}, ${KEYCLOAK_HOST}, ${DNS_HOST}, ${MINIO_HOST}, ${S3_HOST}, ${BEACON_OLLAMA_HOST}, ${BEACON_OLLAMA_WEBUI_HOST}, ${OLLAMA_HOST}, ${LMSTUDIO_HOST}, ${POSTGRESQL_HOST}, ${VECTORDB_HOST}, ${REDIS_HOST}, ${SUPABASE_HOST}, ${CHROMADB_HOST}, ${QA_HOST}, ${TOOLS_HOST}, ${BEACON_TOOLS_DB_HOST} -> ${TARGET_IP}"
